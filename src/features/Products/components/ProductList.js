        ...
        <div>
          ...
          <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <section aria-labelledby="products-heading" className="pb-0 pt-2">
              <div className="grid grid-cols-3 gap-x-8 gap-y-10 lg:grid-cols-4">
                {/* Filters */}
                      ...
                      <div className="mt-0 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:gap-x-8">
                        {products.map((product) => (
                          <Link to={"/productdetail"}>
                            <div key={product.id} className="group relative border-solid border-2 border-gray-400 p-4 rounded-lg">
                              ...
                              <div className="mt-4 flex justify-between">
                                <div>
                                  <h3 className="text-sm  text-gray-700  text-ellipsis">
                                      ...
                                      <span
                                        ...
                                        aria-hidden="true" 
                                        className="absolute max inset-0 "
                                      />
                                      {product.title}
                                  </h3>
                                ...
                                ₹{Math.round(product.price*(1-product.discountPercentage/100)*80)}
                                </p>
                                </div>
                              </div>
                            </div>
